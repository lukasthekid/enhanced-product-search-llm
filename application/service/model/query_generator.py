...
from application.service.evaluation import calculate_semantic_similarity, calculate_rouge, average_cosine_distance
from application.service.utils import RougeScore, average_rouge_scores, SemanticHelper
...
class BartQueryGenerator:
    ...
    def hyperparameter_tuning(self, test_product_ids: [str], data: pd.DataFrame, semanticHelper: SemanticHelper):
        ...
        for params in tqdm(param_grid, desc="Hyperparameter Tuning"):
            ...
            score = 1.5 * avg_rouge + 1.0 * overall_cos_sim_score + 1.0 * overall_diversity_score
            # print(score)
            if score > best_score:
                best_score = score
                best_params = params
